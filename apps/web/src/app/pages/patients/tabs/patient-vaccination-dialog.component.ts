...
@Component({
  selector: 'app-patient-vaccination-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  template: `
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-flat-button color="primary" [disabled]="vaccinationForm.invalid" (click)="onSubmit()">
        Save
      </button>
    </mat-dialog-actions>
  `,
...
export class PatientVaccinationDialogComponent {
  private fb = inject(FormBuilder);
  private dialogRef = inject(MatDialogRef<PatientVaccinationDialogComponent>);
